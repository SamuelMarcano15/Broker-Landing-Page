/*!
 * @license
 * TradingView Lightweight Charts™ v4.2.1-dev+202408041518
            ...
            const drawLabelBody = (labelBackgroundColor, labelBorderColor) => {
                ...
                */
                if (geom._internal_alignRight) {
                    drawRoundRectWithBorder(ctx, gb._internal_xOutside, gb._internal_yTop - 2, gb._internal_totalWidth, gb._internal_totalHeight + 5, labelBackgroundColor, gb._internal_horzBorder, [20, 10, 10, 20], labelBorderColor);
                }
                else {
                    drawRoundRectWithBorder(ctx, gb._internal_xInside, gb._internal_yTop - 2, gb._internal_totalWidth, gb._internal_totalHeight + 5 , labelBackgroundColor, gb._internal_horzBorder, [20, 10, 10, 20], labelBorderColor);
                }
            };
            // draw border
