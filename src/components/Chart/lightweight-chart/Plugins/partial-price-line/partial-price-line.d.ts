...
declare class PartialPriceLineRenderer implements ISeriesPrimitivePaneRenderer {
	_price: number | null;
	_x: number | null;
	_color: string;
...
declare class PartialPriceLineView implements ISeriesPrimitivePaneView {
	_renderer: PartialPriceLineRenderer;
	constructor();
	renderer(): ISeriesPrimitivePaneRenderer;
	update(priceY: number | null, color: string, x: number | null): void;
}
export declare class PartialPriceLine implements ISeriesPrimitive<Time> {
	...
	detached(): void;
	updateAllViews(): void;
	paneViews(): PartialPriceLineView[];
}
