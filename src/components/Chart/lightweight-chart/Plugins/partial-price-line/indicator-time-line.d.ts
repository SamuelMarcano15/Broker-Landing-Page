...
declare class IndicatorTimeLineRenderer implements ISeriesPrimitivePaneRenderer {
	_price: number | null;
	_x: number | null;
	_color: string;
	update(priceY: number | null, color: string, x: number | null): void;
	draw(target: CanvasRenderingTarget2D): void;
}
declare class IndicatorTimeLineView implements ISeriesPrimitivePaneView {
	_renderer: IndicatorTimeLineRenderer;
	constructor();
	renderer(): ISeriesPrimitivePaneRenderer;
	update(priceY: number | null, color: string, x: number | null): void;
}
export declare class IndicatorTimeLine implements ISeriesPrimitive<Time> {
	_paneViews: IndicatorTimeLineView[];
	...
	detached(): void;
	updateAllViews(): void;
	paneViews(): IndicatorTimeLineView[];
}
