...
declare class StackedBarsSeriesRenderer<TData extends StackedBarsData> implements ICustomSeriesPaneRenderer {
	_data: PaneRendererCustomData<Time, TData> | null;
	_options: StackedBarsSeriesOptions | null;
...
export declare class StackedBarsSeries<TData extends StackedBarsData> implements ICustomSeriesPaneView<Time, TData, StackedBarsSeriesOptions> {
	...
	update(data: PaneRendererCustomData<Time, TData>, options: StackedBarsSeriesOptions): void;
	defaultOptions(): StackedBarsSeriesOptions;
}
