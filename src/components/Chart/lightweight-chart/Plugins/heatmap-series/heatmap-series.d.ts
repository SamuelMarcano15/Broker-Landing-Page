...
declare class HeatMapSeriesRenderer<TData extends HeatMapData> implements ICustomSeriesPaneRenderer {
	_data: PaneRendererCustomData<Time, TData> | null;
	_options: HeatMapSeriesOptions | null;
...
export declare class HeatMapSeries<TData extends HeatMapData> implements ICustomSeriesPaneView<Time, TData, HeatMapSeriesOptions> {
