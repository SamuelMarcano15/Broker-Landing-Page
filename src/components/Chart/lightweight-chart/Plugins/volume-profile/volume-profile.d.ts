...
declare class VolumeProfileRenderer implements ISeriesPrimitivePaneRenderer {
	_data: VolumeProfileRendererData;
	constructor(data: VolumeProfileRendererData);
	draw(target: CanvasRenderingTarget2D): void;
}
declare class VolumeProfilePaneView implements ISeriesPrimitivePaneView {
	_source: VolumeProfile;
	_x: Coordinate | null;
	_width: number;
	_columnHeight: number;
	_top: Coordinate | null;
	_items: VolumeProfileItem[];
	constructor(source: VolumeProfile);
	update(): void;
	renderer(): VolumeProfileRenderer;
}
export declare class VolumeProfile implements ISeriesPrimitive<Time> {
	_chart: IChartApi;
