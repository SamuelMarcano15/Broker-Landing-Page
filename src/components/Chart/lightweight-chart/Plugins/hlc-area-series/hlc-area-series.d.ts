...
declare class HLCAreaSeriesRenderer<TData extends HLCAreaData> implements ICustomSeriesPaneRenderer {
	_data: PaneRendererCustomData<Time, TData> | null;
	_options: HLCAreaSeriesOptions | null;
	draw(target: CanvasRenderingTarget2D, priceConverter: PriceToCoordinateConverter): void;
	update(data: PaneRendererCustomData<Time, TData>, options: HLCAreaSeriesOptions): void;
	_drawImpl(renderingScope: BitmapCoordinatesRenderingScope, priceToCoordinate: PriceToCoordinateConverter): void;
}
export declare class HLCAreaSeries<TData extends HLCAreaData> implements ICustomSeriesPaneView<Time, TData, HLCAreaSeriesOptions> {
