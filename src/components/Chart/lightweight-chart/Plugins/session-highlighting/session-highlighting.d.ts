...
export interface SessionHighlightingRendererData {
	x: Coordinate | number;
	color: string;
}
declare class SessionHighlightingPaneRenderer implements ISeriesPrimitivePaneRenderer {
	_viewData: SessionHighlightingViewData;
	constructor(data: SessionHighlightingViewData);
	draw(target: CanvasRenderingTarget2D): void;
}
export interface SessionHighlightingViewData {
	data: SessionHighlightingRendererData[];
	options: Required<SessionHighlightingOptions>;
	barWidth: number;
}
declare class SessionHighlightingPaneView implements ISeriesPrimitivePaneView {
	_source: SessionHighlighting;
	_data: SessionHighlightingViewData;
	constructor(source: SessionHighlighting);
	update(): void;
	renderer(): SessionHighlightingPaneRenderer;
	zOrder(): SeriesPrimitivePaneViewZOrder;
}
...
export declare class SessionHighlighting extends PluginBase implements ISeriesPrimitive<Time> {
	...
	updateAllViews(): void;
	paneViews(): SessionHighlightingPaneView[];
