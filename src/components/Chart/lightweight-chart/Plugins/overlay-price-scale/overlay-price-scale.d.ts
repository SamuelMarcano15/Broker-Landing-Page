...
declare class OverlayPriceScaleRenderer implements ISeriesPrimitivePaneRenderer {
	_data: RendererData | null;
	update(data: RendererData): void;
	draw(target: CanvasRenderingTarget2D): void;
	_calculatePriceScale(height: number, data: RendererData): Label[];
}
declare class OverlayPriceScaleView implements ISeriesPrimitivePaneView {
...
export declare class OverlayPriceScale implements ISeriesPrimitive<Time> {
	...
	applyOptions(options: Partial<OverlayPriceScaleOptions>): void;
	attached({ chart, series, requestUpdate }: SeriesAttachedParameter<Time>): void;
	detached(): void;
	updateAllViews(): void;
	paneViews(): OverlayPriceScaleView[];
}
