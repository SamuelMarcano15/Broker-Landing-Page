...
export interface WhiskerBarItem {
	quartilesY: QuartileTuple;
	outliers: number[];
	x: number;
}
declare class WhiskerBoxSeriesRenderer<TData extends WhiskerData> implements ICustomSeriesPaneRenderer {
	_data: PaneRendererCustomData<Time, TData> | null;
	_options: WhiskerBoxSeriesOptions | null;
	draw(target: CanvasRenderingTarget2D, priceConverter: PriceToCoordinateConverter): void;
	update(data: PaneRendererCustomData<Time, TData>, options: WhiskerBoxSeriesOptions): void;
	_drawImpl(renderingScope: BitmapCoordinatesRenderingScope, priceToCoordinate: PriceToCoordinateConverter): void;
	_drawWhisker(ctx: CanvasRenderingContext2D, bar: WhiskerBarItem, extremeLineWidth: number, options: WhiskerBoxSeriesOptions, horizontalPixelRatio: number, verticalPixelRatio: number, wickWidth: number, horizontalWickWidth: number): void;
	_drawBox(ctx: CanvasRenderingContext2D, bar: WhiskerBarItem, bodyWidth: number, options: WhiskerBoxSeriesOptions, horizontalPixelRatio: number, verticalPixelRatio: number): void;
	_drawMedianLine(ctx: CanvasRenderingContext2D, bar: WhiskerBarItem, medianLineWidth: number, options: WhiskerBoxSeriesOptions, horizontalPixelRatio: number, verticalPixelRatio: number, horizontalLineWidth: number): void;
	_drawOutliers(ctx: CanvasRenderingContext2D, bar: WhiskerBarItem, extremeLineWidth: number, options: WhiskerBoxSeriesOptions, horizontalPixelRatio: number, verticalPixelRatio: number): void;
}
export declare class WhiskerBoxSeries<TData extends WhiskerData> implements ICustomSeriesPaneView<Time, TData, WhiskerBoxSeriesOptions> {
	...
	update(data: PaneRendererCustomData<Time, TData>, options: WhiskerBoxSeriesOptions): void;
	defaultOptions(): WhiskerBoxSeriesOptions;
}
