...
declare class LollipopSeriesRenderer<TData extends LollipopData> implements ICustomSeriesPaneRenderer {
	_data: PaneRendererCustomData<Time, TData> | null;
	_options: LollipopSeriesOptions | null;
	draw(target: CanvasRenderingTarget2D, priceConverter: PriceToCoordinateConverter): void;
	update(data: PaneRendererCustomData<Time, TData>, options: LollipopSeriesOptions): void;
	_drawImpl(renderingScope: BitmapCoordinatesRenderingScope, priceToCoordinate: PriceToCoordinateConverter): void;
}
export declare class LollipopSeries<TData extends LollipopData> implements ICustomSeriesPaneView<Time, TData, LollipopSeriesOptions> {
	...
	update(data: PaneRendererCustomData<Time, TData>, options: LollipopSeriesOptions): void;
	defaultOptions(): LollipopSeriesOptions;
}
