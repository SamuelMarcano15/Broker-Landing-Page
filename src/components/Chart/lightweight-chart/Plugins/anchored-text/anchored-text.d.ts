...
declare class AnchoredTextRenderer implements ISeriesPrimitivePaneRenderer {
	_data: AnchoredTextOptions;
	constructor(options: AnchoredTextOptions);
	draw(target: CanvasRenderingTarget2D): void;
}
declare class AnchoredTextPaneView implements ISeriesPrimitivePaneView {
	private _source;
	constructor(source: AnchoredText);
	update(): void;
	renderer(): AnchoredTextRenderer;
}
export declare class AnchoredText implements ISeriesPrimitive<Time> {
	_paneViews: AnchoredTextPaneView[];
	_data: AnchoredTextOptions;
	constructor(options: AnchoredTextOptions);
	updateAllViews(): void;
	paneViews(): AnchoredTextPaneView[];
	requestUpdate?: () => void;
	attached({ requestUpdate }: SeriesAttachedParameter<Time>): void;
	detached(): void;
	applyOptions(options: Partial<AnchoredTextOptions>): void;
}
