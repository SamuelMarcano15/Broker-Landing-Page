...
declare class BackgroundShadeSeriesRenderer<TData extends LineData> implements ICustomSeriesPaneRenderer {
	_data: PaneRendererCustomData<Time, TData> | null;
	_options: BackgroundShadeSeriesOptions | null;
	draw(target: CanvasRenderingTarget2D): void;
	update(data: PaneRendererCustomData<Time, TData>, options: BackgroundShadeSeriesOptions): void;
	_drawImpl(renderingScope: BitmapCoordinatesRenderingScope): void;
}
export declare class BackgroundShadeSeries<TData extends LineData> implements ICustomSeriesPaneView<Time, TData, BackgroundShadeSeriesOptions> {
	...
	update(data: PaneRendererCustomData<Time, TData>, options: BackgroundShadeSeriesOptions): void;
	defaultOptions(): BackgroundShadeSeriesOptions;
}
