...
class u {
  ...
  draw(t) {
    t.useBitmapCoordinateSpace((e) => {
      ...
      o.lineWidth = this._options.width;

      // Set the line dash pattern for dotted lines
      o.setLineDash([this._options.dashWidth, this._options.dashHeight]); // Adjust the numbers for different dash styles

      // Draw the line
      o.beginPath();
      o.moveTo(n.position, 0);
      o.lineTo(n.position, e.bitmapSize.height);
      o.stroke();
