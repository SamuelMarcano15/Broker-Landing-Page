...
export declare class RectangleDrawingTool {
	private _chart;
	private _series;
	private _drawingsToolbarContainer;
	...
	constructor(chart: IChartApi, series: ISeriesApi<SeriesType>, drawingsToolbarContainer: HTMLDivElement, options: Partial<RectangleDrawingToolOptions>);
