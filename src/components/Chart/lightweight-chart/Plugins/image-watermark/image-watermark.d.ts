...
declare class ImageWatermarkPaneRenderer implements ISeriesPrimitivePaneRenderer {
...
declare class ImageWatermarkPaneView implements ISeriesPrimitivePaneView {
	_source: ImageWatermark;
	_placement: Placement | null;
	constructor(source: ImageWatermark);
	zOrder(): SeriesPrimitivePaneViewZOrder;
	update(): void;
	renderer(): ImageWatermarkPaneRenderer;
	private _determinePlacement;
}
export declare class ImageWatermark implements ISeriesPrimitive<Time> {
	...
	requestUpdate(): void;
	updateAllViews(): void;
	paneViews(): ImageWatermarkPaneView[];
}
