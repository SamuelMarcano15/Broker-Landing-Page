...
declare class CrosshairHighlightPaneView implements ISeriesPrimitivePaneView {
...
export interface CrosshairHighlightData {
	x: number;
	visible: boolean;
	color: string;
	barSpacing: number;
...
export declare class CrosshairHighlightPrimitive implements ISeriesPrimitive<Time> {
	private _options;
	...
	detached(): void;
	paneViews(): CrosshairHighlightPaneView[];
	updateAllViews(): void;
	setData(data: CrosshairHighlightData): void;
	currentColor(): string;
